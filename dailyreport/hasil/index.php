...
<body>
	<p>Date : <?= $_GET['tanggal'] ?><br>
	&#x23F0 Time : 20.30 WIB</p>

	<p>&#x1F477 PIC MTI : BP. SULTONI<br>
	&#x1F477 PIC MTI : <br>
	...
	?>
		...
		Waktu Produksi : <?= $row['jam'] ?>  WIB</p>
		
		<p>- HH Type 1 : <?= $po_hh1 ; ?> | <?= $row['hh1']; ?> | <?php $total_hh1 = $total_hh1 + $row['hh1']; echo $total_hh1; ?> | <?= $po_hh1 - $total_hh1; ?><br>
		- HH Type 2 : <?= $po_hh2 ; ?> | <?= $row['hh2']; ?> | <?php $total_hh2 = $total_hh2 + $row['hh2']; echo $total_hh2; ?> | <?= $po_hh2 - $total_hh2; ?><br>
		- HH Type 3 : <?= $po_hh3 ; ?> | <?= $row['hh3']; ?> | <?php $total_hh3 = $total_hh3 + $row['hh3']; echo $total_hh3; ?> | <?= $po_hh3 - $total_hh3; ?></p>
		<br>	
	<?php
			}
		}
